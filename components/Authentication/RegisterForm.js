        ...
        <div className='register-form'>
          ...
          <form>
            <div className='form-group'>
              <input type='text' className='form-control' placeholder='Referral ID' id='referralId'/>
            </div>
            <div className='row'>
            ...
            <div className='row'>
              ...
              <div className='form-group col-md-6 col-12'>
                ...
                <input type="date" id="dateOfBirth" name="birthday"  className='dobInput' required/>
              </div>
            </div>
            <div className='row'>
              <div className='form-group col-md-6 col-12'>
            ...
            <div class="form-check">
              ...
              I HAVE READ AND AGREE TO THE <Link href='/terms'><a className='terms'>TERMS OF USE</a></Link>  AND <Link href='/policy'><a className='terms'>PRIVACY POLICY</a></Link>.
              </label>
            </div>
