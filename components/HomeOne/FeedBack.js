        ...
        <div className='container'>
          ...
          <div className='row justify-content-center'>
            <div className='col-lg-4 col-md-6 col-sm-12'>
              <div className='single-feedback-box'>
                <div className="subscription-title">
                  <span className="subscription-gold text-center">Bronze</span>
                </div>
                <div className="row">
                  ...
                  <div className="col-6 subscription-details">
                    <h5>ROI</h5> 
                    <h4 className="sub-info">15 - 20 <i className="fa fa-percent icon-sm" /></h4>
                  </div>
                </div>
            ...
            <div className='col-lg-4 col-md-6 col-sm-12'>
              <div className='single-feedback-box'>
                <div className="subscription-title">
                  <span className="subscription-gold text-center">Silver</span>
                </div>
                <div className="row">
                  <div className="col-6 subscription-details">
                    <h5>Investors</h5> 
                  ...
                  <div className="col-6 subscription-details">
                    <h5>ROI</h5> 
                    <h4 className="sub-info">25 - 30 <i className="fa fa-percent icon-sm" /></h4>
                  </div>
                </div>
                <p className="subscription-title">Subscription Fee <span className="sub-info">$50</span></p>
                <h4 className="text-center">Accuracy 85%</h4>
                <div className="subscription-btn">
                  <a href='/subscribtions' className='default-btn '>
                    <i className='bx bxs-user'></i> Subscribe Now
                  </a>
            ...
            <div className='col-lg-4 col-md-6 col-sm-12'>
              <div className='single-feedback-box'>
                <div className="subscription-title">
                  <span className="subscription-gold text-center">Gold</span>
                </div>
                <div className="row">
                  <div className="col-6 subscription-details">
                    <h5>Investors</h5> 
                  ...
                  <div className="col-6 subscription-details">
                    <h5>ROI</h5> 
                    <h4 className="sub-info"> 30 - 35 <i className="fa fa-percent icon-sm" /></h4>
                  </div>
                </div>
