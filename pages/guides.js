        ...
        <div className="container">
            ...
            <div className="row m-0">
              ...
              <div className="col-lg-9 col-md-12 p-0">
                <div className="content">
                  <p>
                    Click{" "}
                    <a href="https://platform.metatradas.com/user/register?ref=qwas01a">
                      Here{" "}
                    </a>{" "}
          ...
          <div className="guides-content">
            ...
            <div className="row m-0">
              ...
              <div className="col-lg-9 col-md-12 p-0">
                <div className="content">
                  <p>Subscribe to any package of your choice.</p>
                  <Link href="/">
                    <a>
            ...
            <div className="row m-0">
              ...
              <div className="col-lg-9 col-md-12 p-0">
                <div className="content">
                  ...
                  <img
                    style={{ maxHeight: "291px", width: "483px" }}
                    src="/images/buy.jpg"
                    alt="image"
                  />
                </div>
          ...
          <div className="guides-content">
            ...
            <div className="row m-0">
              ...
              <div className="col-lg-9 col-md-12 p-0">
                <div className="content">
                  <p>
                    Share your referral link and create extra stream of income
                    to you.
                  </p>
